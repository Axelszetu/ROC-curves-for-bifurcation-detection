...
for (i in (1:5)){
  ...
  #grid <- grid^(1/(5*i))
  plots.var[[i]] <- ROC.maker(H1.data = var.matrix.H1, H0.data = var.matrix.H0, grid = grid, mean0_H1 = mean0_H1_var, var0_H1 = var0_H1_var, mean0_H0 = mean0_H0_var, var0_H0 = var0_H0_var, t.obs = t.obs[i], dt = dt, Tw = T_w_var)
}
...
for (i in (1:5)){
  grid <- seq(from = min_sig_thresh[i], to = 1, length.out = no_gridpoints)
  plots.rho[[i]] <- ROC.maker(H1.data = rho.matrix.H1, H0.data = rho.matrix.H0, grid = grid, mean0_H1 = mean0_H1_rho, var0_H1 = var0_H1_rho, mean0_H0 = mean0_H0_rho, var0_H0 = var0_H0_rho, t.obs = t.obs[i], dt = dt, Tw = T_w_rho)
}
